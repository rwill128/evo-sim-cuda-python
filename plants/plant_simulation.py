...
def grow_plants(world_params):
	vectorized_grow_plants(world_params['alive_plant_ages'],
	                       world_params['alive_plant_energy'],
	                       world_params['num_alive_segments'],
	                       world_params['energy_cost_per_frame'])
...
# @njit(cache=True)
def vectorized_grow_plants(alive_plant_ages: np.ndarray, alive_plant_energy: np.ndarray, num_alive_segments: np.ndarray, energy_cost_per_frame: np.ndarray):
	alive_plant_ages += 1
	alive_plant_energy = alive_plant_energy - (num_alive_segments * energy_cost_per_frame)
